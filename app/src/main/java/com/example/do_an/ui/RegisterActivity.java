        ...
        btdkyREcnt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (edMK.getText().toString().isEmpty() || edMK2.getText().toString().isEmpty()) {
                    ...
                    Toast.makeText(RegisterActivity.this, "Mật khẩu phải là 6 chữ số", Toast.LENGTH_SHORT).show();
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(RegisterActivity.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show(); // Khi lưu thất bại
                        }
                    }
