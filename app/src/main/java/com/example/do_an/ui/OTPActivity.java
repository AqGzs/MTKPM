            ...
            public void onClick(View view) {
                ...
                else
                {
                    ...
                    if(!check.equals("1")){
                        ...
                        Toast.makeText(OTPActivity.this, "Vui lòng tạo mật khẩu để đăng ký tài khoản", Toast.LENGTH_SHORT).show();

                    }
                    else {
                        intent = new Intent(OTPActivity.this, ForgetPassActivity.class);
                        Toast.makeText(OTPActivity.this, "Vui lòng tạo lại mật khẩu để đăng nhập tài khoản", Toast.LENGTH_SHORT).show();
