        ...
        btnt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(soduviNT.getText() == null)
                    Toast.makeText(RechargeActivity.this, "Chưa nhập số tiền cần nạp", Toast.LENGTH_SHORT).show();
                else{
                    int sodu = Integer.parseInt(String.valueOf(soduviNT.getText()));
                    if(sodu < 10000)
                        Toast.makeText(RechargeActivity.this, "Nạp tối thiểu 10.000đ", Toast.LENGTH_SHORT).show();
                    else
                                ...
                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            ...
                                            Toast.makeText(RechargeActivity.this, "Lỗi khi nạp tiền: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
                    } else {
                        Toast.makeText(RechargeActivity.this, "Không tìm thấy người dùng", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(RechargeActivity.this, "Lỗi khi truy cập dữ liệu: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void updateNotification(String titletran, String pricetran, String date, String hour){
        ...
        db.collection("TransactionInfo").add(notificationMap)
                .addOnSuccessListener(documentReference -> {
                    Toast.makeText(RechargeActivity.this, "Thông tin đã được đẩy lên Firebase", Toast.LENGTH_SHORT).show();
                })
                .addOnFailureListener(e -> {
                    Toast.makeText(RechargeActivity.this, "Lỗi khi đẩy thông tin lên Firebase: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                });
    }
